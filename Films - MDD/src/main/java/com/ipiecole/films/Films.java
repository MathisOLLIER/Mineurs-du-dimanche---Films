...
//    public FilmsData getFilmData() throws IOException {
//        return (FilmsData) getFilms(this.getPageContents("http://rss.allocine.fr/ac/cine/prochainement?format=xml"));
//    }
    ...
    public class XMLtoJson {
        List<FilmsData> XMLtoJSON = new ArrayList<>();
    }
    ...
    public List<String> getFilmsJson (){
        List<FilmsData> filmsDataJson = new ArrayList<>();
        Genson genson = new GensonBuilder().useRuntimeType(true).create();
        List<String> json = genson.serialize(getFilms(filmsDataJson));
        return json;
    }
...
//                        Element eElement = (Element) nNode;
//
//                        String titre = "Title : " + eElement.getElementsByTagName("title").item(0).getTextContent();
...
//        FilmsData filmsData = new FilmsData(new Container(<FilmsData>(
//                Arrays.asList()
//                )))
//    }
}
